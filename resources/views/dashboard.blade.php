                    ...
                    <div class="col-span-12 2xl:col-span-9">
                        <div class="grid grid-cols-12 gap-6">
                            ...
                            <div class="col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-3 mt-2 lg:mt-6 xl:mt-2">
                                ...
                                <div class="report-box-2 intro-y mt-5">
                                    <div class="box p-5">
                                        <ul class=" nav nav-pills w-4/5 bg-slate-100 rounded-md mx-auto "
                                            role="tablist">
                            ...
                            <div class="col-span-12 lg:col-span-6 mt-6">
                                <div class="box p-8 relative overflow-hidden bg-primary intro-y">
                                    ...
                                    <div
                                        class="w-full sm:w-72 leading-relaxed text-white/70 mt-3">
                                        Apply now, quick registration.</div>
                                    <button
                                        class="btn w-32 bg-white mt-6 sm:mt-10">Start
                                        Now</button>
                            ...
                            <div class="col-span-12 lg:col-span-6 mt-6">
                                <div class="box p-8 relative overflow-hidden intro-y">
                                    <div
                                        class="leading-[2.15rem] w-full sm:w-52 text-primary text-xl -mt-3">
                            ...
                            <div class="col-span-12 mt-6">
                                <div class="intro-y block sm:flex items-center h-10">
                                    ...
                                    <div class="flex items-center sm:ml-auto mt-3 sm:mt-0">
                                        ...
                                        <button
                                            class="ml-3 btn box flex items-center text-slate-600">
                                            <i data-feather="file-text" class="hidden sm:block w-4 h-4 mr-2"></i>
                                        ...
                                        <div class="intro-x box">
                                            <div class="p-5">
                                                ...
                                                <div class="grid grid-cols-7 gap-4 mt-5 text-center">
                                                    ...
                                                    <div
                                                        class="py-0.5 bg-success/20 rounded relative">
                                                        6</div>
                                                    ...
                                                    <div
                                                        class="py-0.5 bg-pending/20 rounded relative">
                                                        23</div>
                                                    <div class="py-0.5 rounded relative">24</div>
                                                    <div class="py-0.5 rounded relative">25</div>
                                                    <div class="py-0.5 rounded relative">26</div>
                                                    <div
                                                        class="py-0.5 bg-primary/10 rounded relative">
                                                        27</div>
