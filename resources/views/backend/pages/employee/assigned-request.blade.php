                                    ...
                                    @if ($assignedRequest->status == 'accepted')
                                        ...
                                        <td>
                                            <button class="flex items-center btn btn-primary text-white"
                                                ...
                                                <i data-feather="check-square" class="w-4 h-4 mr-1 text-white"></i> Picked
                                            </button>
                                        </td>
                                    @endif
                                </tr>
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-body p-0">
                                                ...
                                                <div class="px-5 pb-8 text-center">
                                                    ...
                                                    <form
                                                        action="{{ route('assigned-request.accept', $assignedRequest->id) }}"
                                                        method="GET">
                                                        @csrf
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-body p-0">
                                                ...
                                                <div class="px-5 pb-8 text-center">
                                                    ...
                                                    <form
                                                        action="{{ route('assigned-request.pick', $assignedRequest->id) }}"
                                                        method="GET">
                                                        @csrf
                                                        <button type="button" data-tw-dismiss="modal"
                                                            class="btn btn-outline-secondary w-24 mr-1">Cancel</button>
