                            ...
                            <div id="edit-seller-modal-{{ $pendingRequest->id }}" class="modal" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-xl p-2">
                                    <div class="modal-content p-8">
                                        ...
                                        <form class="text-lg" action="{{ url('sell-request/update/' . $pendingRequest->id) }}"
